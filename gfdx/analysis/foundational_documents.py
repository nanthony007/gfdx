...
api_key = '5E21E0FE11A1F430927A1186D98F3E8F' # NICK API ADDED HERE PLEASE FIX 
project = Project(URL, api_key)

# Pulls out variables of interest from REDCap in table format
fields_of_interest = ['country_code', 'mf_comment', 'mf_original_source_english', 'ls_types_comment_english', 'ls_source_english', 'ls_origins_comment_english', 'ls_uses_comment_english']
...
final.drop(['mf_comment', 'mf_original_source_english', 'ls_types_comment_english', 'ls_origins_comment_english', 'ls_source_english', 'ls_uses_comment_english'], axis=1, inplace=True)

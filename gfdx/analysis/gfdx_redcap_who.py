...
for i, row in df_copy.iterrows():
    ...
    # Maize
        ...
        df_copy.loc[
            i, "who_compound"
        ] = "NaFeEDTA, ferrous sulfate, ferrous fumarate, or electrolytic iron"
...
for i, row in df_copy.iterrows():
    if row.redcap_event_name == "oil_arm_1" or row.redcap_event_name == "rice_arm_1":
        df_copy.loc[
            i, "compound_include"
        ] = "No WHO recommendation available for this food"
        ...
        row.redcap_event_name == "maize_flour_arm_1"
        and row.nutrient_compound in recommended_compounds_maize
    ):
        df_copy.loc[i, "compound_include"] = "WHO Recommended"
    elif (
        row.redcap_event_name == "salt_arm_1"
...
for i, row in df_copy.iterrows():
    if (
        (
            row.redcap_event_name == "maize_flour_arm_1"
            or row.redcap_event_name == "wheat_flour_arm_1"
        )
...
for i, row in df_copy1.iterrows():
    ...
    elif row.redcap_event_name == "salt_arm_1" and (
    ...
    # Maize
        ...
        row.redcap_event_name == "maize_flour_arm_1" and row.nutrient_compound == 71
    ):  # Niacinamide
        df_copy1.loc[i, "who_rec_level"] = 36
    elif (
        row.redcap_event_name == "maize_flour_arm_1" and row.nutrient_compound == 72
    ):  # Riboflavin
        df_copy1.loc[i, "who_rec_level"] = 2.0
    elif (
        row.redcap_event_name == "maize_flour_arm_1" and row.nutrient_compound == 3
    ):  # Pyridoxine Hydrochloride
        df_copy1.loc[i, "who_rec_level"] = 6.2
    elif (
        row.redcap_event_name == "maize_flour_arm_1" and row.nutrient_compound == 81
    ):  # Thiamin Hydrochloride
        df_copy1.loc[i, "who_rec_level"] = 3.9
    elif row.redcap_event_name == "maize_flour_arm_1" and (
        ...
        row.redcap_event_name == "maize_flour_arm_1" and row.nutrient_compound == 64
    ):  # NaFeEDTA
        if row.latest_intake_api < 75:
        ...
        row.redcap_event_name == "maize_flour_arm_1" and row.nutrient_compound == 38
    ):  # Electrolytic iron
        ...
        row.redcap_event_name == "maize_flour_arm_1" and row.nutrient_compound == 29
    ):  # Folic acid
        if row.latest_intake_api < 75:
        ...
        if row.latest_intake_api < 75:
            ...
            df_copy1.loc[i, "who_rec_level"] = "30"
    # Wheat
    elif row.redcap_event_name == "wheat_flour_arm_1" and (
        row.nutrient_compound == 50 or row.nutrient_compound == 55
    ):  # Ferrous sulfate, Ferrous fumarate
        if row.latest_intake_api < 75:
            df_copy1.loc[i, "who_rec_level"] = "60"
        ...
        row.redcap_event_name == "wheat_flour_arm_1" and row.nutrient_compound == 64
    ):  # NaFeEDTA
        if row.latest_intake_api < 75:
            df_copy1.loc[i, "who_rec_level"] = "40"
        elif row.latest_intake_api >= 75 and row.latest_intake_api < 150:
        ...
        row.redcap_event_name == "wheat_flour_arm_1" and row.nutrient_compound == 38
    ):  # Electrolytic iron
        if row.latest_intake_api >= 150 and row.latest_intake_api <= 300:
            df_copy1.loc[i, "who_rec_level"] = "60"
        elif row.latest_intake_api > 300:
        ...
        row.redcap_event_name == "wheat_flour_arm_1" and row.nutrient_compound == 29
    ):  # Folic acid
        if row.latest_intake_api < 75:
            df_copy1.loc[i, "who_rec_level"] = "5.0"
        elif row.latest_intake_api >= 75 and row.latest_intake_api < 150:
...
for country in df_copy1.country_code.unique():
    ...
    if (
        "wheat_flour_arm_1" in s.redcap_event_name.values
        and "maize_flour_arm_1" in s.redcap_event_name.values
    ):
        s2 = s[
            (s.redcap_event_name == "wheat_flour_arm_1")
            | (s.redcap_event_name == "maize_flour_arm_1")
        ]
